...
global.dfail = (type, m, conn) => {
  const msg = {
        rowner: '*『 الميزه هادي للمطور فقط! 』*',
        owner: '*『 الميزه دي للمطور   ! 』*',
        mods: '*『 الميزه دي لمطور البوت بس ! 』*',
        premium: '*『 الميزه دي للاعضاء المميزين بس ! 』*',
        group: '*『 الميزه دي في الجروبات بس ! 』*',
        private: '*『 الميزه هادي فالبريفي - الخاص  ! 』*',
        admin: '*『 الميزه هادي للادمن ! 』*',
        botAdmin: '*『 ارفع البوت ادمن  ! 』*',
        unreg: '*[ لحظة !! انت لست مسجلا ]*\n\n*『سجل الامر ليتفعل  』*\n*➣ #تسجيل*',
        restrict: '*『هاد الميزه  المطور محيدها ! 』*'
    }[type]
